...
const modules = [
  "Network Foundations – How Computers & Internet Work",
  "Cybersecurity Basics – Introduction to Cybersecurity",
  "Hackers & Attacks – Types of Cyber Threats",
  "Passwords & Authentication – Account Protection",
  "Digital Safety & Privacy – Staying Safe Online",
  "Cyber Security Certifications"
];

export default function VeryBasic() {
        ...
        <div className="relative max-w-5xl w-full bg-black/80 backdrop-blur-xl p-8 rounded-2xl border border-cyan-400/40 shadow-[0_0_40px_#22d3ee44]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {modules.map((m,i)=>(
              ...
              <motion.div
                key={i}
                onClick={()=>navigate(`/verybasic/${i+1}`)}
