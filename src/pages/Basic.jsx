...
const modules = [
  "Authentication – Password & Authentication Fundamentals",
  "Phishing Detection – Phishing Fundamentals",
  "Malware Defense – Malware Fundamentals",
  "Network Security – Network Security and SOC Operations",
